...
print()
print(colored("Author   : cyberwarrior 'cbd' 127001", 'green'))
print(colored("Website : 127001", 'magenta'))
print(colored("Github   : https://github.com/CyberWarrior127001/CyberSpace01", 'red'))
print(colored("Facebook : 127001", 'green'))
print(colored("YouTube : 127001", 'green'))
print(colored("Linkedin : 127001", 'magenta'))
print(colored("Instagram : 127001", 'yellow'))
print(colored("Twitter : 127001", 'green'))
...
print(colored("127001 Is not responsible for misusing it and must have an NDA signed to perform such attacks", 'red'))
